...
```html
<link rel="stylesheet"
  href="https://cdn.jsdelivr.net/gh/jabopiti/farn-theme@0.8.0/dist/farn.css">
```

> Replace `0.8.0` with the [latest release tag](https://github.com/jabopiti/farn-theme/releases), or pin it for stability.
